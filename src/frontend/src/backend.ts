...
export class Backend implements backendInterface {
    ...
    async acknowledgeAlert(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async addEvent(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: bigint, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createBackup(arg0: string, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async deleteBackup(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async dismissAlert(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getBackups(): Promise<Array<BackupRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBackups();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEvents(): Promise<Array<SecurityEvent>> {
        if (this.processError) {
            try {
    ...
    async lockSystem(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.lockSystem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async restoreBackup(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.restoreBackup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unlockSystem(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unlockSystem();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
